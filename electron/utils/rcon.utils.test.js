...
describe('rcon.utils', () => {
    ...
    beforeEach(() => {
        ...
        Object.keys(rcon_utils_1.rconClients).forEach(key => {
            delete rcon_utils_1.rconClients[key];
        });
    ...
    describe('rconClients', () => {
        it('should export rconClients as an empty object initially', () => {
            expect(rcon_utils_1.rconClients).toEqual({});
        });
    });
    describe('connectRcon', () => {
        ...
        it('should return early if already connected', () => {
            rcon_utils_1.rconClients['instance1'] = mockRconInstance;
            const onStatus = jest.fn();
            (0, rcon_utils_1.connectRcon)('instance1', mockConfig, onStatus);
        ...
        it('should connect successfully on first attempt', () => {
            ...
            const authCall = mockRconInstance.on.mock.calls.find((call) => call[0] === 'auth');
            authCall[1]();
            expect(rcon_utils_1.rconClients['instance1']).toBe(mockRconInstance);
            expect(onStatus).toHaveBeenCalledWith(true);
        });
        it('should retry on connection end before auth', () => {
            ...
            const endCall = mockRconInstance.on.mock.calls.find((call) => call[0] === 'end');
            endCall[1]();
        ...
        it('should give up after max attempts and call onStatus with false', () => {
            ...
            expect(rcon_utils_1.rconClients['instance1']).toBeUndefined();
        });
        it('should handle errors and retry', () => {
            ...
            const errorCall = mockRconInstance.on.mock.calls.find((call) => call[0] === 'error');
        ...
        it('should use default port if not specified', () => {
            ...
            (0, rcon_utils_1.connectRcon)('instance1', configWithoutPort);
        ...
        it('should use default password if not specified', () => {
            ...
            (0, rcon_utils_1.connectRcon)('instance1', configWithoutPassword);
    ...
    describe('disconnectRcon', () => {
        it('should disconnect and remove client if connected', () => {
            rcon_utils_1.rconClients['instance1'] = mockRconInstance;
            (0, rcon_utils_1.disconnectRcon)('instance1');
        ...
        it('should handle disconnect errors gracefully', () => {
            ...
            rcon_utils_1.rconClients['instance1'] = mockClient;
            // Should not throw despite the disconnect error
            expect(() => (0, rcon_utils_1.disconnectRcon)('instance1')).not.toThrow();
            expect(rcon_utils_1.rconClients['instance1']).toBeUndefined();
        });
    });
    describe('sendRconCommand', () => {
        it('should send command and resolve with response', async () => {
            ...
            const promise = (0, rcon_utils_1.sendRconCommand)('instance1', command);
            // Simulate response
            const responseCall = mockRconInstance.once.mock.calls.find((call) => call[0] === 'response');
        ...
        it('should reject if RCON not connected', async () => {
            try {
                await (0, rcon_utils_1.sendRconCommand)('instance1', 'test');
        ...
        it('should reject on error', async () => {
            ...
            const promise = (0, rcon_utils_1.sendRconCommand)('instance1', 'test');
            // Simulate error
            const errorCall = mockRconInstance.once.mock.calls.find((call) => call[0] === 'error');
    ...
    describe('isRconConnected', () => {
        it('should return true if connected', () => {
            rcon_utils_1.rconClients['instance1'] = mockRconInstance;
            expect((0, rcon_utils_1.isRconConnected)('instance1')).toBe(true);
        });
        it('should return false if not connected', () => {
            expect((0, rcon_utils_1.isRconConnected)('instance1')).toBe(false);
        });
    });
    describe('cleanupAllRconConnections', () => {
        it('should disconnect all clients', () => {
            ...
            rcon_utils_1.rconClients['instance1'] = mockClient1;
            rcon_utils_1.rconClients['instance2'] = mockClient2;
        ...
        it('should handle disconnect errors gracefully', () => {
            ...
            rcon_utils_1.rconClients['instance1'] = mockClient;
            // Should not throw despite the disconnect error
            expect(() => (0, rcon_utils_1.cleanupAllRconConnections)()).not.toThrow();
            expect(rcon_utils_1.rconClients).toEqual({});
        });
