...
const installerUtilsMutable = installerUtils;
...
describe('installer.utils', () => {
    ...
    beforeEach(() => {
        ...
        // Mock pty processes
        let extractExitCallback;
        let extractDataCallback;
        mockProc = {
            onData: jest.fn(),
            onExit: jest.fn(),
            kill: jest.fn(),
        ...
        mockExtractProc = {
            onData: (callback) => { extractDataCallback = callback; },
            onExit: (callback) => { extractExitCallback = callback; },
            kill: jest.fn(),
            removeAllListeners: jest.fn(),
        };
