...
// Initialize service
const linuxDepsService = new linux_deps_service_1.LinuxDepsService();
...
*/
messaging_service_1.messagingService.on('check-linux-deps', async (payload, sender) => {
 ...
 * @param sender - The sender of the message, used to route the response.
*/
messaging_service_1.messagingService.on('validate-sudo-password', async (payload, sender) => {
 ...
 * @param sender - The sender of the message, used to route the response.
*/
messaging_service_1.messagingService.on('install-linux-deps', async (payload, sender) => {
 ...
 * @param sender - The sender of the message, used to route the response.
*/
messaging_service_1.messagingService.on('get-linux-deps-list', (payload, sender) => {
    const { requestId } = payload || {};
    try {
