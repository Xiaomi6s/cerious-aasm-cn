...
const mockWebServerService = web_server_service_1.webServerService;
// Store handler functions for testing
let startWebServerHandler;
let stopWebServerHandler;
let webServerStatusHandler;
describe('Web Server Handler', () => {
    ...
    beforeEach(() => {
        ...
        settings_service_1.settingsService.getGlobalConfig.mockReturnValue({
            authenticationEnabled: false,
            authenticationUsername: '',
            authenticationPassword: ''
        });
        settings_service_1.settingsService.getWebServerAuthConfig.mockReturnValue({
            enabled: false,
            username: '',
            password: ''
        });
