...
let configureAutostartHandler;
let configureCrashDetectionHandler;
let configureScheduledRestartHandler;
let getAutomationStatusHandler;
let autoStartOnAppLaunchHandler;
describe('Automation Handler', () => {
    ...
    describe('configure-autostart event', () => {
        ...
        it('should handle undefined payload', async () => {
            ...
            expect(mockAutomationService.configureAutostart).toHaveBeenCalledWith(undefined, undefined, undefined);
            expect(mockMessagingService.sendToOriginator).toHaveBeenCalledWith('configure-autostart', {
                success: true,
                requestId: undefined
            }, mockSender);
    ...
    describe('configure-crash-detection event', () => {
        ...
        it('should handle undefined payload (cover || {} branch)', async () => {
            ...
            expect(mockAutomationService.configureCrashDetection).toHaveBeenCalledWith(undefined, undefined, undefined, undefined);
            expect(mockMessagingService.sendToOriginator).toHaveBeenCalledWith('configure-crash-detection', {
                success: true,
                requestId: undefined
            }, mockSender);
    ...
    describe('configure-scheduled-restart event', () => {
        ...
        it('should handle configure scheduled restart exception', async () => {
            const payload = { serverId: 'test-server', enabled: true, frequency: 'daily', time: '02:00', days: [1, 2, 3], warningMinutes: 30 };
        ...
        it('should handle undefined payload (cover || {} branch)', async () => {
            ...
            expect(mockAutomationService.configureScheduledRestart).toHaveBeenCalledWith(undefined, undefined, undefined, undefined, undefined, undefined);
            expect(mockMessagingService.sendToOriginator).toHaveBeenCalledWith('configure-scheduled-restart', {
                success: true,
                requestId: undefined
            }, mockSender);
    ...
    describe('get-automation-status event', () => {
        ...
        it('should handle undefined payload (cover || {} branch)', async () => {
            ...
            expect(mockAutomationService.getAutomationStatus).toHaveBeenCalledWith(undefined);
            expect(mockMessagingService.sendToOriginator).toHaveBeenCalledWith('get-automation-status', {
                success: true,
                status: { foo: 'bar' },
                requestId: undefined
