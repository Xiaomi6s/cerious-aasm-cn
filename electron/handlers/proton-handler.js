...
const proton_service_1 = require("../services/proton.service");
// Initialize service
const protonService = new proton_service_1.ProtonService();
 ...
 */
electron_1.ipcMain.handle('check-proton-installed', async () => {
    try {
 ...
 */
electron_1.ipcMain.handle('install-proton', async () => {
    try {
 ...
 */
electron_1.ipcMain.handle('get-proton-dir', async () => {
    try {
