...
const backupHandler = __importStar(require("./backup-handler"));
// Mock the services
...
const mockBackupService = backup_service_1.backupService;
// Store handler functions for testing
let createBackupHandler;
let getBackupListHandler;
let restoreBackupHandler;
let deleteBackupHandler;
let getBackupSettingsHandler;
let saveBackupSettingsHandler;
let startBackupSchedulerHandler;
let stopBackupSchedulerHandler;
let getSchedulerStatusHandler;
let downloadBackupHandler;
