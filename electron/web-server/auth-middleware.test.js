...
const auth_middleware_1 = require("../web-server/auth-middleware");
// Mock dependencies
jest.mock('crypto');
jest.mock('express');
...
describe('auth-middleware', () => {
    ...
    describe('generateSessionToken', () => {
        it('should generate a secure random token', () => {
            ...
            const token = (0, auth_middleware_1.generateSessionToken)();
    ...
    describe('sessionAuth', () => {
        it('should call next() when auth is disabled', () => {
            ...
            (0, auth_middleware_1.sessionAuth)(req, res, mockNext);
    ...
    describe('ensureAuthInitialized', () => {
        it('should call next() when auth is already initialized', async () => {
            ...
            const req = mockRequest();
            const res = mockResponse();
            await (0, auth_middleware_1.ensureAuthInitialized)(req, res, mockNext);
            expect(mockNext).toHaveBeenCalled();
        });
        it('should wait for auth initialization', async () => {
            ...
            const req = mockRequest();
            const res = mockResponse();
            const promise = (0, auth_middleware_1.ensureAuthInitialized)(req, res, mockNext);
    ...
    describe('createSession', () => {
        it('should create and set a session cookie', () => {
            mockCrypto.randomBytes.mockReturnValue(Buffer.from('testtoken1234567890123456'));
            const res = mockResponse();
            (0, auth_middleware_1.createSession)(res, 'testuser');
            ...
            expect(res.cookie).toHaveBeenCalledWith('session', '74657374746f6b656e31323334353637383930313233343536', {
                httpOnly: true,
                secure: false,
                sameSite: 'strict',
    ...
    describe('isAuthenticated', () => {
        it('should return true for valid session', () => {
            ...
            const req = mockRequest();
            req.headers = { cookie: 'session=validtoken' };
            const result = (0, auth_middleware_1.isAuthenticated)(req);
