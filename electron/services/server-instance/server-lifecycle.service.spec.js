...
describe('ServerLifecycleService', () => {
    ...
    let arkPathUtilsMock;
    let arkCommandUtilsMock;
    let buildArkServerArgsMock;
    let isPortInUseMock;
    let getPlatformMock;
    let rconServiceMock;
    ...
    describe('startServerInstance', () => {
        it('should start server instance successfully', async () => {
            ...
            const result = await server_lifecycle_service_1.serverLifecycleService.startServerInstance(instanceId, instance);
    ...
    describe('stopServerInstance', () => {
        it('should stop server instance', async () => {
            ...
            const result = await server_lifecycle_service_1.serverLifecycleService.stopServerInstance(instanceId);
    ...
    describe('restartServerInstance', () => {
        it('should restart server instance successfully', async () => {
            ...
            serverManagementServiceMock.prepareInstanceConfiguration.mockResolvedValue(undefined);
            serverProcessServiceMock.startServerProcess.mockResolvedValue({ success: true });
            const result = await server_lifecycle_service_1.serverLifecycleService.restartServerInstance(instanceId, instance);
            expect(result).toEqual({ success: true, instanceId });
        });
    ...
    describe('cleanupOrphanedArkProcesses', () => {
        it('should cleanup on Linux', () => {
            ...
            server_lifecycle_service_1.serverLifecycleService.cleanupOrphanedArkProcesses();
        ...
        it('should handle errors gracefully', () => {
            ...
            expect(() => server_lifecycle_service_1.serverLifecycleService.cleanupOrphanedArkProcesses()).not.toThrow();
        });
    });
    describe('startArkServerInstance', () => {
        it('should start ARK server instance successfully', async () => {
            ...
            serverManagementServiceMock.prepareInstanceConfiguration.mockResolvedValue(undefined);
            serverProcessServiceMock.startServerProcess.mockResolvedValue({ success: true });
            const result = await server_lifecycle_service_1.serverLifecycleService.startArkServerInstance(instanceId);
