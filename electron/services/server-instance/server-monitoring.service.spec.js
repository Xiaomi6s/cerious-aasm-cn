...
describe('ServerMonitoringService', () => {
    let getProcessMemoryUsageMock;
    let rconServiceMock;
    let setupLogTailingMock;
    let getInstanceMock;
    let getInstanceStateMock;
    let pathMock;
    let serverLifecycleServiceMock;
    let storedIntervalCallbacks = {};
    ...
    beforeEach(() => {
        ...
        jest.spyOn(global, 'setInterval').mockImplementation((cb, delay) => {
    ...
    describe('getInstanceState', () => {
        it('should get instance state successfully', () => {
            ...
            const result = server_monitoring_service_1.serverMonitoringService.getInstanceState('instance1');
    ...
    describe('getInstanceLogs', () => {
        it('should get logs for running server', () => {
            ...
            const result = server_monitoring_service_1.serverMonitoringService.getInstanceLogs('instance1', 100);
            expect(result).toEqual({
                log: 'line1\nline2',
                instanceId: 'instance1'
            });
        ...
        it('should get logs for starting server', () => {
            ...
            jest.mocked(require('../../utils/ark/ark-server/ark-server-logging.utils')).getInstanceLogs = getInstanceLogsMock;
            const result = server_monitoring_service_1.serverMonitoringService.getInstanceLogs('instance1');
            expect(result).toEqual({
                log: 'starting log',
                instanceId: 'instance1'
            });
    ...
    describe('setupLogMonitoring', () => {
        it('should setup log monitoring successfully', () => {
            ...
            server_monitoring_service_1.serverMonitoringService.setupLogMonitoring('instance1', instance, jest.fn(), jest.fn());
        ...
        it('should handle missing instance', () => {
            ...
            server_monitoring_service_1.serverMonitoringService.setupLogMonitoring('instance1', {}, jest.fn(), jest.fn());
    ...
    describe('startPlayerPolling', () => {
        it('should start player polling', async () => {
            ...
            server_monitoring_service_1.serverMonitoringService.startPlayerPolling('instance1', callback);
            await executePollingCallbacks();
            expect(callback).toHaveBeenCalledWith('instance1', 5);
            expect(server_monitoring_service_1.serverMonitoringService.getLatestPlayerCount('instance1')).toBe(5);
        });
        ...
        it('should clear existing polling when starting new', async () => {
            ...
            server_monitoring_service_1.serverMonitoringService.startPlayerPolling('instance1', callback1);
            server_monitoring_service_1.serverMonitoringService.startPlayerPolling('instance1', callback2);
            rconServiceMock.executeRconCommand.mockResolvedValue({
                success: true,
    ...
    describe('stopPlayerPolling', () => {
        it('should stop player polling', () => {
            const callback = jest.fn();
            server_monitoring_service_1.serverMonitoringService.startPlayerPolling('instance1', callback);
            server_monitoring_service_1.serverMonitoringService.stopPlayerPolling('instance1');
            rconServiceMock.executeRconCommand.mockResolvedValue({
                success: true,
        ...
        it('should handle stopping non-existent polling', () => {
            // Should not throw
            server_monitoring_service_1.serverMonitoringService.stopPlayerPolling('nonexistent');
        });
    });
    describe('startMemoryPolling', () => {
        it('should start memory polling', async () => {
            ...
            server_monitoring_service_1.serverMonitoringService.startMemoryPolling('instance1', callback);
            await executePollingCallbacks();
        ...
        it('should clear existing polling when starting new', async () => {
            const callback1 = jest.fn();
            const callback2 = jest.fn();
            server_monitoring_service_1.serverMonitoringService.startMemoryPolling('instance1', callback1);
            server_monitoring_service_1.serverMonitoringService.startMemoryPolling('instance1', callback2);
    ...
    describe('stopMemoryPolling', () => {
        it('should stop memory polling', () => {
            const callback = jest.fn();
            server_monitoring_service_1.serverMonitoringService.startMemoryPolling('instance1', callback);
            server_monitoring_service_1.serverMonitoringService.stopMemoryPolling('instance1');
            const mockProcess = { pid: 123 };
            serverLifecycleServiceMock.getServerProcess.mockReturnValue(mockProcess);
            getProcessMemoryUsageMock.mockReturnValue(512);
        ...
        it('should handle stopping non-existent polling', () => {
            // Should not throw
            server_monitoring_service_1.serverMonitoringService.stopMemoryPolling('nonexistent');
        });
    });
    describe('getPlayerCountFromRcon', () => {
        it('should parse standard player count format', async () => {
            ...
            const result = await server_monitoring_service_1.serverMonitoringService.getPlayerCountFromRcon('instance1');
    ...
    describe('getLatestPlayerCount', () => {
        it('should return stored player count', () => {
            server_monitoring_service_1.serverMonitoringService.updatePlayerCount('instance1', 5);
            const result = server_monitoring_service_1.serverMonitoringService.getLatestPlayerCount('instance1');
            expect(result).toBe(5);
        });
        it('should return 0 for unknown instance', () => {
            const result = server_monitoring_service_1.serverMonitoringService.getLatestPlayerCount('unknown');
            expect(result).toBe(0);
        });
    });
    describe('getPlayerCount', () => {
        it('should return player count result', () => {
            server_monitoring_service_1.serverMonitoringService.updatePlayerCount('instance1', 8);
            const result = server_monitoring_service_1.serverMonitoringService.getPlayerCount('instance1');
            expect(result).toEqual({
                instanceId: 'instance1',
                players: 8
            });
    ...
    describe('updatePlayerCount', () => {
        it('should update player count', () => {
            server_monitoring_service_1.serverMonitoringService.updatePlayerCount('instance1', 12);
            expect(server_monitoring_service_1.serverMonitoringService.getLatestPlayerCount('instance1')).toBe(12);
        });
    });
});
