...
describe('ServerInstanceService', () => {
    ...
    describe('getStandardEventCallbacks', () => {
        it('should return standard event callbacks', () => {
            ...
            const callbacks = server_instance_service_1.serverInstanceService.getStandardEventCallbacks(instanceId);
    ...
    describe('startServerInstance', () => {
        it('should start server instance successfully', async () => {
            ...
            const result = await server_instance_service_1.serverInstanceService.startServerInstance(instanceId, onLog, onStateChange);
    ...
    describe('importServerFromBackup', () => {
        it('should import server from backup file path', async () => {
            ...
            const result = await server_instance_service_1.serverInstanceService.importServerFromBackup(serverName, backupFilePath);
        ...
        it('should import server from file data', async () => {
            ...
            serverManagementServiceMock.importFromBackup.mockResolvedValue({ success: true, instance: { id: 'new-instance' } });
            const result = await server_instance_service_1.serverInstanceService.importServerFromBackup(serverName, undefined, fileData, fileName);
            expect(result).toEqual({ success: true, instance: { id: 'new-instance' } });
        ...
        it('should handle missing parameters', async () => {
            const result = await server_instance_service_1.serverInstanceService.importServerFromBackup('');
            expect(result).toEqual({
                success: false,
    ...
    describe('forceStopInstance', () => {
        it('should force stop instance on Windows', async () => {
            ...
            const result = await server_instance_service_1.serverInstanceService.forceStopInstance(instanceId);
            expect(result).toEqual({
                success: true,
                instanceId,
                instanceName: 'Test Server',
    ...
    describe('cleanupOrphanedArkProcesses', () => {
        ...
        it('should handle errors gracefully', () => {
            ...
            // Should not throw
            expect(() => server_instance_service_1.serverInstanceService.cleanupOrphanedArkProcesses()).not.toThrow();
        });
    });
});
