...
describe('ServerOperationsService', () => {
    ...
    describe('connectRcon', () => {
        it('should connect RCON successfully', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.connectRcon(instanceId);
        ...
        it('should handle invalid instance ID', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.connectRcon('invalid');
            expect(result).toEqual({
                success: false,
        ...
        it('should handle instance not found', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.connectRcon('instance1');
            expect(result).toEqual({
                success: false,
    ...
    describe('disconnectRcon', () => {
        it('should disconnect RCON successfully', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.disconnectRcon('instance1');
            expect(result).toEqual({
                success: true,
                connected: false,
                instanceId: 'instance1'
    ...
    describe('getRconStatus', () => {
        it('should get RCON status successfully', () => {
            ...
            const result = server_operations_service_1.serverOperationsService.getRconStatus('instance1');
            expect(result).toEqual({
                success: true,
                connected: true,
                instanceId: 'instance1'
    ...
    describe('executeRconCommand', () => {
        it('should execute RCON command successfully', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand(instanceId, command);
            expect(result).toEqual({
                success: true,
                response: 'Player1, Player2',
                instanceId
        ...
        it('should handle invalid instance ID', async () => {
            validateInstanceIdMock.mockReturnValue(false);
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand('invalid', 'command');
            expect(result).toEqual({
                success: false,
                error: 'Invalid instance ID',
                instanceId: 'invalid'
        ...
        it('should handle invalid command', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand('instance1', '');
            expect(result).toEqual({
                success: false,
        ...
        it('should handle null command', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand('instance1', null);
            expect(result).toEqual({
                success: false,
                error: 'Invalid command',
                instanceId: 'instance1'
        ...
        it('should handle command execution failure', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand('instance1', 'InvalidCommand');
            expect(result).toEqual({
                success: false,
                error: 'Command failed',
                instanceId: 'instance1'
        ...
        it('should handle exception', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.executeRconCommand('instance1', 'command');
            expect(result).toEqual({
                success: false,
                error: 'RCON error',
                instanceId: 'instance1'
    ...
    describe('sendChatMessage', () => {
        it('should send chat message', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.sendChatMessage('instance1', 'Hello world');
    ...
    describe('kickPlayer', () => {
        it('should kick player', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.kickPlayer('instance1', 'BadPlayer');
    ...
    describe('banPlayer', () => {
        it('should ban player', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.banPlayer('instance1', 'BadPlayer');
    ...
    describe('unbanPlayer', () => {
        it('should unban player', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.unbanPlayer('instance1', 'GoodPlayer');
    ...
    describe('saveWorld', () => {
        it('should save world', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.saveWorld('instance1');
    ...
    describe('getServerInfo', () => {
        it('should get server info', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.getServerInfo('instance1');
    ...
    describe('listPlayers', () => {
        it('should list players', async () => {
            ...
            const result = await server_operations_service_1.serverOperationsService.listPlayers('instance1');
    ...
    describe('broadcast', () => {
        it('should broadcast message', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.broadcast('instance1', 'Server maintenance in 5 minutes');
    ...
    describe('setMessageOfTheDay', () => {
        it('should set message of the day', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.setMessageOfTheDay('instance1', 'Welcome to our server!');
    ...
    describe('destroyTribe', () => {
        it('should destroy tribe', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.destroyTribe('instance1', '12345');
    ...
    describe('destroyPlayer', () => {
        it('should destroy player', async () => {
            validateInstanceIdMock.mockReturnValue(true);
            rconServiceMock.executeRconCommand.mockResolvedValue({ success: true });
            const result = await server_operations_service_1.serverOperationsService.destroyPlayer('instance1', '67890');
