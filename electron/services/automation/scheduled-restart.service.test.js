...
function makeAutomation(overrides = {}, nextRestart) {
    return {
        serverId: 'id',
        settings: {
            ...
            restartFrequency: (overrides.restartFrequency ?? 'daily'),
            restartTime: '04:00',
            restartDays: [0],
...
describe('ScheduledRestartService', () => {
    let automations;
    let service;
    let serverInstanceService;
    let serverProcessService;
    let getInstance;
    let saveInstance;
    let sendRconCommand;
    let isRconConnected;
    ...
    it('should execute scheduled restart with RCON', async () => {
        ...
        automation.scheduledRestartTimer = {};
