...
exports.whitelistService = exports.WhitelistService = void 0;
// Whitelist Service - Manages ARK server exclusive join/whitelist functionality
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const ark_path_utils_1 = require("../utils/ark/ark-path.utils");
/**
...
class WhitelistService {
     ...
     */
    getInstanceWhitelistPath(instanceDir) {
     ...
     */
    getMainWhitelistPath() {
        const arkServerDir = ark_path_utils_1.ArkPathUtils.getArkServerDir();
     ...
     */
    writeWhitelistFile(instanceDir, playerIds) {
        try {
     ...
     */
    loadWhitelistFromInstance(instanceDir) {
        try {
     ...
     */
    addToInstanceWhitelist(instanceDir, playerId) {
        try {
     ...
     */
    removeFromInstanceWhitelist(instanceDir, playerId) {
        try {
            const loadResult = this.loadWhitelistFromInstance(instanceDir);
            if (!loadResult.success) {
                return loadResult;
     ...
     */
    isPlayerWhitelistedInInstance(instanceDir, playerId) {
        try {
            const loadResult = this.loadWhitelistFromInstance(instanceDir);
            if (!loadResult.success) {
                return false;
     ...
     */
    copyWhitelistToMainDir(instanceDir) {
        try {
            const instanceWhitelistPath = this.getInstanceWhitelistPath(instanceDir);
            const mainWhitelistPath = this.getMainWhitelistPath();
