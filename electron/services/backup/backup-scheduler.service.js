...
class BackupSchedulerService {
     ...
     */
    async startBackupSchedulerInternal(instanceId, settings, createBackupCallback) {
     ...
     */
    stopBackupSchedulerInternal(instanceId) {
     ...
     */
    async getSchedulerStatus(instanceId, settings) {
        try {
